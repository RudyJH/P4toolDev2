...
This example demonstrates how to set up a FastAPI application with a SQLite database,
...
# To run from command line: fastapi dev FastAPI-ex4-Startup.py  
# 
# Old :  FastAPI-ex4-Startup:app --reload
...
# --- View ---
# Create a folder named 'templates' and add this file:
# filepath: /home/rudyj/Desktop/R-Pi/FastAPI/templates/index.html
'''
<!DOCTYPE html>
<html>
...
<body>
    ...
    <h2> End of FastAPI List test 1</h2>
</body>
</html>
'''
